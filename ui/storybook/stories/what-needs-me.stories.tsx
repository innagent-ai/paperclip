...
const IMAGES = [
  { assetId: thumb("#479BFF", "1"), alt: "screenshot 1" },
...
const PROJECTS: Record<string, AttentionItem["project"]> = {
  "appr-1": { id: "proj-alpha", name: "Alpha", urlKey: "alpha", color: "#35726C", icon: "rocket" },
  "intx-1": { id: "proj-alpha", name: "Alpha", urlKey: "alpha", color: "#35726C", icon: "rocket" },
...
const SHOWCASE: AttentionItem[] = [
  {
    ...item("plan-1", "issue_thread_interaction", "high", "Approve plan: Attention queue redesign", "A plan is awaiting your approval.", {
      ...
      project: { id: "proj-alpha", name: "Alpha", urlKey: "alpha", color: "#35726C", icon: "rocket" },
    }),
