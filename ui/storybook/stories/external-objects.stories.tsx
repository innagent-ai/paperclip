...
function projectsRollupStory() {
  ...
  const projects = [
    ...
    { name: "Auth provider", color: "#9DAC00", summary: summary({ auth: 1 }) },
  ];
  return (
    ...
    <div className="paperclip-story mx-auto w-[320px] rounded border border-border bg-background p-2">
      ...
      <ul className="flex flex-col">
        {[
          ...
          { name: "Marketing site", color: "#5ABE73", summary: { ...summary, highestSeverity: "warning", byStatusCategory: { waiting: 2 }, total: 2, objects: [] } },
