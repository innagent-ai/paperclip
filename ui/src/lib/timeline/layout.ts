...
export const TIMELINE_COLORS = {
  ...
  cancelled: "#A1A2A4",
  now: "#106FD0", // Gallery feedback r2: "now" liveness marker = status blue (was teal #66BBFF); shape (1.5px vertical line) still distinguishes it from #479CFF delegated bars.
} as const;
