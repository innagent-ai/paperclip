...
export const brandChipBadge: Record<BrandChipColor, string> = {
  ...
  blue: "bg-[#DAEAFF] text-[#005EB7] border-[#106FD0] dark:bg-[#106FD02e] dark:text-[#106FD0] dark:border-[#106FD073]",
  amber: "bg-[#EEFF7F] text-[#717B00] border-[#B0C000] dark:bg-[#B0C00024] dark:text-[#B0C000] dark:border-[#B0C00073]",
  green: "bg-[#E2FAEA] text-[#3E854C] border-[#5ABE73] dark:bg-[#5ABE731f] dark:text-[#5ABE73] dark:border-[#5ABE7373]",
  violet: "bg-[#EBECEE] text-[#004F9B] border-[#0D6DCF] dark:bg-[#0D6DCF2e] dark:text-[#0D6DCF] dark:border-[#0D6DCF73]",
  red: "bg-[#FFE2DF] text-[#A00015] border-[#D53537] dark:bg-[#D535372e] dark:text-[#D53537] dark:border-[#D5353773]",
};
 ...
 */
export const runningLabelText = "text-[#005EB7] dark:text-[#106FD0]";
...
export const brandBanner: Record<BannerTone, string> = {
  info: "border-[#106FD0]/40 bg-[#DAEAFF]/50 text-[#005EB7] dark:border-[#106FD059] dark:bg-[#106FD014] dark:text-[#95C4FF]",
  warning: "border-[#B0C000]/50 bg-[#EEFF7F]/60 text-[#717B00] dark:border-[#B0C00059] dark:bg-[#B0C00012] dark:text-[#B0C000]",
