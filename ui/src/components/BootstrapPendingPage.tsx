    ...
    <div className="mt-6 border-t border-border pt-5">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        {hasActiveInvite
          ...
          : "Rode este comando no servidor do InnAgent para gerar a URL de convite do primeiro administrador:"}
      </p>
...
export function BootstrapPendingPage({
  ...
  if (!claimAvailable) {
    return (
      <StateChrome>
        ...
        <h1 className="text-xl font-semibold">Este InnAgent espera o primeiro administrador</h1>
        <p className="mt-2 text-sm text-muted-foreground">
  ...
  if (!session) {
    return (
      <StateChrome>
        <PaperclipLockup className="mb-6 h-6 w-auto" />
        <h1 className="text-xl font-semibold">Vamos configurar o InnAgent</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Ninguém assumiu esta instância ainda. Entre ou crie sua conta InnAgent para ser o primeiro
